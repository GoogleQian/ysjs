...
public class DateUtil {
 ...
 public static final Long staterTime= System.currentTimeMillis() + 60*1000L;
    //获取两个Date时间差，按秒返回
     ...
     * @param
     * @return
     * @throws ParseException long 2013-8-16 下午02:55:34
     */
    ...
    /**
     * yyyyMMddHHmmss字符串格式转时间类型
     *
     * @param dateStr
     * @return
     */
    public static Date strToDate(String dateStr) {
        LocalDateTime ldt = LocalDateTime.parse(dateStr, DateTimeFormatter.ofPattern("yyyyMMddHHmmss"));
        DateTimeFormatter fa = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        return DateUtil.parse(ldt.format(fa), DATE_TIME_FORMAT);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("本程序存在秒后自动退出");

//        String datetime = "20140212111012";
//        System.out.println(new Date());
//        System.out.println(strToDate(datetime).getTime());
//        String time = "2010-11-20 11:10:10";
//        Date date = null;
//        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//       Date dd= formatter.parse(time);
//
//        System.out.println(DateUtil.parse("2018-06-30 23:45:51", DATE_TIME_FORMAT));
//        System.out.println(DateUtil.parse("2018-06-30 23:45:51"));
