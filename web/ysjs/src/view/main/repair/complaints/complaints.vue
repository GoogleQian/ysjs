...
export default {
  ...
  methods: {
    getList() {
      ...
      const params = { page: this.page.currentPage, ...this.searchForm, repairerId: Number(localStorage.getItem('userId')) };
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          const params = {...this.dialogData,  repairerId: Number(localStorage.getItem('userId'))};
